        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <form id="formrecopilar" action="#" method="post" role="form">
                   <input type="hidden" id="oper" name="oper" value="publicar" />
                   ...
                   <div id="pnlIdsParticipantes" class="row" style="display: none;">
                       <div class="col-md-12">
                           <div class="form-group">
...
<script	type="text/javascript" src="js/enc_publicarEncuesta.js"></script>
