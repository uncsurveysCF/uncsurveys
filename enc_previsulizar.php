...
<html lang="en">
    <head>
        ...
        <link href="r/css/styleValEngine.css" rel="stylesheet">
    ...
    <body class="bckIni">
        ...
        <div class="ch-container" style="background: #ffffff;">
            <div class="row">
                <div id="content" class="col-lg-12 col-sm-12">
                    ...
                    <!-- content starts -->
                    <div class="row" id="divPrueba">
                        <div class="box col-md-12">
                            <div class="alert alert-success">
                                <strong>Vista Previa!</strong> <br /> 
                                No se guardaran los datos de esta previsualizaci&oacute;n.
                            </div>
                        </div>
                    </div>
        ...
        <!-- external javascript -->
        <script type="text/javascript" src="r/js/jquery-latest.js"></script>
        <script type="text/javascript" src="r/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="r/js/jquery.bootstrap.wizard.js"></script>
        <script type="text/javascript" src="r/js/jquery.validation.js"></script>
        <script type="text/javascript" src="r/js/jquery.validationEngine-es.js"></script>
        ...
        <script type="text/javascript" src="js/previsualizarEncuesta.js"></script>
